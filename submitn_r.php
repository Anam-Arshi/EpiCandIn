...
<td>
<input type="text" name="loca" placeholder="Please specify"></input>
</td>
...
<div id="riskMultiselect" class="multiselect">
      ...
      <div id="riskSelectOptions" class="mySelectOptions">
		  <?php
		  $riskFactors = array('Pregnancy', 'Oral contraceptives', 'Current Antibiotic use', 'Hospital stay', 'Current Alcohol intake', 'Smoking', 'Current steroid use', 'Risky sexual behaviour', "Protein energy malnutrition") ;
		  ...
		  ?>
		  <label for='other' ><input type='checkbox' id='otherRisk' value='other' name='risk[]' onClick="showHideRisk()"/>Type of undergarment used</label>
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" placeholder="Synthetic/Cotton" style="width:50%;padding:3px;">
		 
		 <label for='other' ><input type='checkbox' id='otherRisk' value='other' name='risk[]' onClick="showHideRisk()"/>Use of vaginal wash or douching</label>
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" placeholder="Name/Brand" style="width:50%;padding:3px;">
      ...
      <div id="NicSelectOptions" class="mySelectOptions">
		 ...
		 /*  $getni = mysqli_query($conn, "select distinct niche from niche_infected where niche !='-' order by niche ASC");
		  ...
		  ?>
		   ...
		   <label for='other' onChange="showHide5()"><input type='checkbox' id='otherNiche' value='other' name='niche[]' />Ear</label>
		    <label for='other' onChange="showHide5()"><input type='checkbox' id='otherNiche' value='other' name='niche[]' />Eyes</label>
			 <label for='other' onChange="showHide5()"><input type='checkbox' id='otherNiche' value='other' name='niche[]' />Nails</label>
			 <label for='other' onChange="showHide5()"><input type='checkbox' id='otherNiche' value='other' name='niche[]' />Oropharynx</label>
        <label for='other' onChange="showHide5()"><input type='checkbox' id='otherNiche' value='other' name='niche[]' />Skin</label>
		<label for='other' onChange="showHide5()"><input type='checkbox' id='otherNiche' value='other' name='niche[]' />Urinary tract</label>
		<label for='other' onChange="showHide5()"><input type='checkbox' id='otherNiche' value='other' name='niche[]' />Vagina</label>
...
<td>
<textarea  name="inf_pre" width="100" height="100" placeholder="Initial diagnosis"></textarea>
</td>
...
<table class="table table-sm table-bordered">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>Amphotericin B<input type="checkbox" name="cs_isavuconazole" value="yes" class="form-control">
                                                                </td>
                                                                <td>
                                                                    <div class="form-check-inline form-check cs_isavuconazole_type" style="">
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_isavuconazole_type" value="S" class=" form-check-input">S
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_isavuconazole_type" value="R" class="form-check-input">R
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_isavuconazole_type" value="MIC" class="form-check-input">MIC
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_isavuconazole_type" value="N/A" class="form-check-input">N/A
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="cs_isavuconazole_type_mic" value="" placeholder="Please Specify" class="form-control cs_isavuconazole_type_mic" style="">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Flucytosine<input type="checkbox" name="cs_voriconazole" value="yes" class="form-control cs_voriconazole">
                                                                </td>
                                                                <td>
                                                                    <div class="form-check-inline form-check cs_voriconazole_type" style="">
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_voriconazole_type" value="S" class=" form-check-input">S
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_voriconazole_type" value="R" class="form-check-input">R
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_voriconazole_type" value="MIC" class="form-check-input">MIC
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_voriconazole_type" value="N/A" class="form-check-input">N/A
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="cs_voriconazole_type_mic" value="" placeholder="Please Specify" class="form-control cs_voriconazole_type_mic" style="display: none;">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    Itraconazole <input type="checkbox" name="cs_itraconazole" value="yes" class="form-control">
                                                                </td>
                                                                <td>
                                                                    <div class="form-check-inline form-check cs_itraconazole_type" style="display: none;">
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_itraconazole_type" value="S" class=" form-check-input">S
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_itraconazole_type" value="R" class="form-check-input">R
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_itraconazole_type" value="MIC" class="form-check-input">MIC
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_itraconazole_type" value="N/A" class="form-check-input">N/A
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="cs_itraconazole_type_mic" value="" placeholder="Please Specify" class="form-control cs_itraconazole_type_mic" style="display: none;">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    Fluconazole <input type="checkbox" name="cs_fluconazole" value="yes" class="form-control">
                                                                </td>
                                                                <td>
                                                                    <div class="form-check-inline form-check cs_fluconazole_type" style="display: none;">
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_fluconazole_type" value="S" class=" form-check-input">S
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_fluconazole_type" value="R" class="form-check-input">R
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_fluconazole_type" value="MIC" class="form-check-input">MIC
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_fluconazole_type" value="N/A" class="form-check-input">N/A
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="cs_fluconazole_type_mic" value="" placeholder="Please Specify" class="form-control cs_fluconazole_type_mic" style="display: none;">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    Caspofungin <input type="checkbox" name="cs_caspofungin" value="yes" class="form-control cs_caspofungin">
                                                                </td>
                                                                <td>
                                                                    <div class="form-check-inline form-check cs_caspofungin_type" style="display: none;">
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_caspofungin_type" value="S" class=" form-check-input">S
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_caspofungin_type" value="R" class="form-check-input">R
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_caspofungin_type" value="N/A" class="form-check-input">N/A
                                                                        </label>
                                                                    </div>
                                                                </td>
																<td>
																<label class="form-check-label ">
                                                                            <input type="radio" name="cs_micafungin_type" value="MIC" class="form-check-input">MIC
                                                                        </label>
																</td>
                                                                <td>
                                                                    <input type="text" name="cs_caspofungin_type_mic" value="" placeholder="Please Specify" class="form-control cs_caspofungin_type_mic" style="display: none;">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    Micafungin <input type="checkbox" name="cs_micafungin" value="yes" class="form-control">
                                                                </td>
                                                                <td>
                                                                    <div class="form-check-inline form-check cs_micafungin_type" style="display: none;">
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_micafungin_type" value="S" class=" form-check-input">S
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_micafungin_type" value="R" class="form-check-input">R
                                                                        </label>
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        
                                                                        <label class="form-check-label ">&nbsp; &nbsp;</label>
                                                                        <label class="form-check-label ">
                                                                            <input type="radio" name="cs_micafungin_type" value="N/A" class="form-check-input">N/A
                                                                        </label>
                                                                    </div>
                                                                </td>
																<td>
                                                                ...
                                                                <td>
                                                                    <input type="text" name="cs_micafungin_type_mic" value="" placeholder="Please Specify" class="form-control cs_micafungin_type_mic" style="display: none;">
                                                                </td>
                                                            </tr>
