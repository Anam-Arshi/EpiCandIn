...
<canvas id="year_2022" style="width:100%;max-width:1200px"></canvas>
<?php 
include "connect.php";
...
$res=mysqli_query($conn, "SELECT count(DISTINCT Study_ids) as cont FROM data where Niche_Infected LIKE '%$val%' and Year_of_Publication > 2020");
