...
<td>
<input type="text" id="result" name='duratn' />
<script>
...
<div id="SympMultiselect" class="multiselect">
      ...
      <div id="SympSelectOptions" class="mySelectOptions">
		  <label for='dental'><input type='checkbox' id='dental' onchange='checkboxStatusChangeSymp()' value='dental' name='symp[]'/>Dental caries</label>
		 <label for='dyspar'><input type='checkbox' id='dyspar' onchange='checkboxStatusChangeSymp()' value='dyspar' name='symp[]'/>Dyspareunia</label>
		 ...
		 <label for='oral'><input type='checkbox' id='oral' onchange='checkboxStatusChangeSymp()' value='oral' name='symp[]'/>Oral lesions</label>
		 <label for='burn'><input type='checkbox' id='burn' onchange='checkboxStatusChangeSymp()' value='burn' name='symp[]'/>Vaginal burning & redness</label>
		 <label for='disch'><input type='checkbox' id='disch' onchange='checkboxStatusChangeSymp()' value='disch' name='symp[]'/>Vaginal discharge</label>
		 <label for='itch'><input type='checkbox' id='itch' onchange='checkboxStatusChangeSymp()' value='itch' name='symp[]'/>Vaginal itching</label>
...
<select name="anti" id="anti" onChange="showHide3()" style="margin-bottom: 5px;">
<option value="">Select</option>
...
<tr><th>Drug</th><th>Mode of Administration</th><th>Dose</th><th>add/remove</th></tr>
<tr>
<td width="30px">
...
<td class="chkbx">
Male: <input type="number" name='gender[]'></input>
Female: <input type="number"  name='gender[]'></input><br>
Other: <input type="number"  name='gender[]'></input>
</td>
...
<td>
<div id="IdeMetMultiselect" class="multiselect" style="width: 82%;">
      ...
      <div id="IdeMetSelectOptions" class="mySelectOptions">
		  ...
		  <label for='Gram stain'><input type='checkbox' id='koh' onchange='checkboxStatusChangeIdeMet()' value='koh' name='ident[]'/>Microscopy: KOH wet mount</label>
		  ...
		  <label for='Gram stain'><input type='checkbox' id='autovitek' onchange='checkboxStatusChangeIdeMet()' value='autovitek' name='ident[]'/>Automated VITEK system<input type="text" name="vit" placeholder="write cards used for identification" size="6" style="width: 300px; margin:4px; border:1px solid black;"/></label>
		  ...
		  <label for='NGS'><input type='checkbox' id='NGS' onchange='checkboxStatusChangeIdeMet()' value='NGS' name='ident[]' />Sequencing</label>
...
while($row=mysqli_fetch_array($getsps))
{
   ...
   <div id="hidden-field_afd" style="display: none;" style="width:200px;">
	...
	<td>
      <i class='fa-duotone fa-plus' title="Add row" style="font-weight: bold;cursor: pointer; background: #C5E3EB; padding: 0px 2px;" onclick="addRowAsp()"></i>
...
<td>
<div id="astTestMultiselect" class="multiselect" style="width: 82%;">
      ...
      <div id="astTestSelectOptions" class="mySelectOptions">
		  ...
		  <label for='broth'><input type='checkbox' id='broth' onchange='checkboxStatusChangeastTest()' value='broth' name='ast[]'/>Broth microdilution method<input type="text" name="vit" placeholder="write guidelines followed CLSI/EUCAST" size="6" style="width: 330px; margin:4px; border:1px solid black;"/></label>
...
<table width="400" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
    ...
    <tr>
     <div class="g-recaptcha captcha" data-sitekey="6Ld2_IgoAAAAAGc3DySB904JYGmmS0Hisb6my42o" align="center"></div>
                          	<br/>
		                    <div align="center">
                            <button type="submit" class="square_btn" value="Submit"  >Submit</button>	
                            &nbsp;&nbsp;&nbsp;
