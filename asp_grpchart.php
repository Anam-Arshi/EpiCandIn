...
$get_dr = mysqli_query($conn, "select distinct Drug from asp where study_ids = '$st_id' and $i != '';");	
	...
	foreach($dr as $val){
			...
			$res1 = mysqli_query($conn, "select $i, Drug from asp where Disease_Category='$dc1' and Drug='$val' and study_ids = '$st_id' and $i != ''");
		    $res2 = mysqli_query($conn, "select $i, Drug from asp where Disease_Category='$dc2' and Drug='$val' and study_ids = '$st_id' and $i != ''");
	...
	#}
	 ...
	 #echo $val_csv; 
if (preg_match('~[0-9]+~', $val_csv)) {
?>
<main align="center"></main>
<script>
var grp = "<?php echo $i;?>"
