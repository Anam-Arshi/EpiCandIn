...
<td>
<input type="text"  name="pid" value="id0123" style="border: none;
  border-bottom: 2px solid black; width: 120px;"/>
</td>
...
<td width="47%">
<strong>Name of site <h5>*</h5></strong>
</td>
...
<td>
<input type="text"  name="nameSubmitter"/>
</td>
...
<input type="text" name="age" size="10" id="age" style="border: none;
  border-bottom: 2px solid black; width: 50px;"></input><span> years</span>
</td>
...
$cnt=0;
	...
	$set= explode(",", $def);
?>
<input type="checkbox" id="1" name="set[]" value="Male" <?php if (in_array("Male", $set))
  {
  echo "checked";
  }?>>
  <label for="1">Male</label>
  
  <input type="checkbox" id="2" name="set[]" value="Female"   <?php if (in_array("Female", $set))
  {
  echo "checked";
  }?>>
